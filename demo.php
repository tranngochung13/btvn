 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="demo.php?action=add&code=<?php echo $row["code"]; ?>">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="demo.php?action=delete&code=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
